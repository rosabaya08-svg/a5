  ...
  if (!isLegacyInnopayEnabled()) {
    return {
      ...
      credentials: {
        ...
        active: 0,
        activeMidCount: 0,
        smsStartReadyCount: 0,
        smsConfirmReadyCount: 0,
        vbankReadyCount: 0,
        cancelReadyCount: 0,
        rows: [],
      },
      readiness: {
        readyForSmsStart: false,
        readyForSmsConfirm: false,
        readyForVbank: false,
        readyForCancel: false,
        realPgCanBeCalled: false,
        missing: ["A5_ENABLE_LEGACY_INNOPAY disabled"],
      },
    };
  }
