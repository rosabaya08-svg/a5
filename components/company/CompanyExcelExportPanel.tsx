...
const productImportTemplateExampleRows: CompanyExcelProductImportRow[] = [{
...
const productImportTemplateRows: CompanyExcelProductImportRow[] = productImportTemplateExampleRows.slice(0, 0);
