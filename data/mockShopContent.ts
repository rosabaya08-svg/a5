...
export const productProfiles: MallProductProfile[] = [
  {
    ...
    detailTabs: [
      { title: "상품 상세", body: "산후조리원 객실에서 바로 확인할 수 있는 베이비 스킨케어 모의 상세 영역입니다." },
      { title: "배송/수령", body: "현장수령과 택배배송 모두 가능한 모의 정책입니다. 실제 배송조회 API는 연결하지 않습니다." },
  ...
  },
  {
    ...
    badges: ["신상품", "옵션 재고 주의"],
    tags: ["산모", "의류", "신상품"],
    review: { rating: 4.6, count: 46, highlight: "가볍고 객실에서 착용하기 편한 모의 후기" },
    detailTabs: [
      { title: "상품 상세", body: "사이즈 옵션과 재고 상태를 확인하는 산모 의류 모의 상세입니다." },
      { title: "배송/수령", body: "택배배송 우선 상품으로 표시되며 실제 운송장 입력은 기업 관리자 모의 화면에서만 예약합니다." },
  ...
  },
  {
    ...
    badges: ["브랜드관 추천", "택배배송"],
    tags: ["외출", "프리미엄", "브랜드관"],
    review: { rating: 4.7, count: 82, highlight: "수납 공간이 넉넉한 외출 준비 모의 후기" },
    detailTabs: [
      { title: "상품 상세", body: "브랜드관 노출과 기획전 연결을 고려한 프리미엄 상품 상세 모의 화면입니다." },
  ...
  },
  {
    ...
    tags: ["식품", "영양", "간식"],
    review: { rating: 4.4, count: 31, highlight: "구성 확인이 필요한 식품 모의 상품" },
    detailTabs: [
      { title: "상품 상세", body: "식품 표시사항과 알레르기 안내가 필요한 모의 상세입니다." },
      { title: "배송/수령", body: "택배배송 모의 상태이며 실제 식품 배송 정책은 미연동입니다." },
  ...
  },
  {
    ...
    badges: ["40% 특가", "택배배송"],
    tags: ["산모", "티", "회복"],
    review: { rating: 4.5, count: 57, highlight: "부담 없이 마시기 좋은 모의 후기" },
    detailTabs: [
      { title: "상품 상세", body: "원재료와 섭취 주의 문구를 표시해야 하는 산모 케어 모의 상세입니다." },
      { title: "배송/수령", body: "택배배송 모의 상태로 표시합니다." },
  ...
  },
  {
    ...
    badges: ["베스트", "현장수령 가능"],
    tags: ["산모", "리빙", "회복"],
    review: { rating: 4.9, count: 73, highlight: "객실에서 바로 체감되는 편안함 모의 후기" },
    detailTabs: [
      { title: "상품 상세", body: "객실 사용 이미지와 상세 설명을 배치할 모의 상세 영역입니다." },
  ...
  },
  {
    ...
    badges: ["기획전", "재고 여유"],
    tags: ["베이비", "리빙", "선물"],
    review: { rating: 4.7, count: 64, highlight: "선물용으로 좋은 모의 후기" },
    detailTabs: [
      { title: "상품 상세", body: "소재, 크기, 세탁 안내를 담는 모의 상세 영역입니다." },
      { title: "배송/수령", body: "택배배송과 현장수령 모두 모의 상태로 표시합니다." },
...
export const marketingSlots: MarketingSlot[] = [
  {
    ...
    status: "approved",
    owner: "SUPER_ADMIN",
    performance: "노출 12,480 / 클릭 842 모의",
  },
  {
    id: "slot-promo-video",
    title: "산모케어 영상 광고",
    ...
    owner: "COMPANY_ADMIN",
    performance: "Storage 검수 전 임시 소재",
  },
  {
    id: "slot-brand-grid",
    title: "브랜드 로고 그리드",
    placement: "공식 브랜드 파트너",
    target: "전체 고객",
    period: "상시",
    status: "approved",
    owner: "SUPER_ADMIN",
    performance: "브랜드관 연결 모의",
  },
  {
    id: "slot-popup",
    title: "퇴실 전 픽업 안내 팝업",
