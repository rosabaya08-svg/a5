...
function getNurserySessionSnapshot() {
  return JSON.stringify(readPortalSession("nursery") ?? null);
}
...
export function NurseryConsentSummary() {
  const snapshot = useSyncExternalStore(subscribeToSessionChange, getNurserySessionSnapshot, getServerSnapshot);
