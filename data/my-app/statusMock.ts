...
export const statusMetrics: StatusMetric[] = [
  {
    ...
    value: "88%",
    helper: "Static estimate based on generated preview routes, UI components, mock data, and reports.",
    tone: "progress",
  },
  {
    id: "metric-files",
    label: "Major files",
    value: "78",
    helper: "Preview pages, components, data/types, and track reports created in this worktree.",
    tone: "complete",
  },
  {
    id: "metric-routes",
...
export const humanChecks: StatusListItem[] = [
  ...
  {
    id: "human-validation",
    title: "Validation deferred",
    detail: "Lint, build, and browser smoke were forbidden during unattended mode.",
    tone: "blocked",
  },
  {
    id: "human-live",
...
export const progressEvents: ProgressEvent[] = [
  ...
  },
  {
    ...
    detail: "Lint, build, and browser smoke are intentionally left for the next working day.",
    state: "deferred",
  },
  {
    id: "event-live",
