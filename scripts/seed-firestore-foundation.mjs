...
const records = [
  ...
  record("audit_logs", "audit-foundation-seed", {
    ...
    status: "active",
    message: "Seeded with.commerce foundation documents for beta storefront and operations.",
    risk_level: "info",
  }),
];
