...
export function buildProductCatalogCmsRecord(draft: ProductDraft, sourceChannel = "company_product_edit_apply"): CmsRecord {
  ...
  return {
    ...
    list_price: null,
    listPrice: null,
    comparison_candidate_list_price: listPrice > 0 ? listPrice : null,
    comparisonCandidateListPrice: listPrice > 0 ? listPrice : null,
    comparison_candidate_open_mall_price: platformLowestPrice > 0 ? platformLowestPrice : null,
    comparisonCandidateOpenMallPrice: platformLowestPrice > 0 ? platformLowestPrice : null,
