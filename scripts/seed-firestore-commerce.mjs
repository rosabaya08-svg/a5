...
if (process.env.ALLOW_LEGACY_MOCK_SEED !== "1") {
  console.error(
    "Blocked legacy mock commerce seed. Use scripts/seed-test-1004-firestore.mjs for the 7592901311 test company, or set ALLOW_LEGACY_MOCK_SEED=1 intentionally.",
  );
  process.exit(1);
}
...
const qrSessions = [
  ...
  },
  {
    ...
    created_at: "2026-05-19T15:31:00+09:00",
    expiresAt: "2026-05-19T18:31:00+09:00",
    expires_at: "2026-05-19T18:31:00+09:00",
    deliveryMethod: "pickup",
    delivery_method: "pickup",
    totalAmount: 72000,
    total_amount: 72000,
...
const orders = [
  ...
  },
  {
    ...
    itemIds: ["A5-20260519-002-1"],
    item_ids: ["A5-20260519-002-1"],
    guest_lookup_enabled: true,
    guest_write_enabled: true,
    source: "firestore_commerce_seed",
  },
  {
    id: "A5-20260519-003",
    order_id: "A5-20260519-003",
    orderNo: "A5-20260519-003",
    order_no: "A5-20260519-003",
    qrSessionId: "MOMQR72",
    qr_session_id: "MOMQR72",
    nurseryId: "nursery-gangnam-01",
    nursery_id: "nursery-gangnam-01",
    ...
    paid_at: "2026-05-19T15:36:00+09:00",
    createdAt: "2026-05-19T15:31:00+09:00",
    created_at: "2026-05-19T15:31:00+09:00",
    itemIds: ["A5-20260519-003-1"],
    item_ids: ["A5-20260519-003-1"],
    guest_lookup_enabled: true,
    guest_write_enabled: true,
    source: "firestore_commerce_seed",
  },
