  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[0.85fr_1.15fr]">
      <form className="rounded-md border border-slate-200 bg-white p-4">
        <p className="text-xs font-bold uppercase tracking-[0.08em] text-slate-500">비회원 조회</p>
        <h2 className="mt-1 text-xl font-black text-slate-950">주문 찾기</h2>
        <div className="mt-4 grid gap-3">
          <label className="grid gap-1">
            <span className="text-sm font-bold text-slate-700">주문번호</span>
            <input
          ...
          <label className="grid gap-1">
            <span className="text-sm font-bold text-slate-700">휴대폰 번호</span>
            <input
              className="rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-slate-950"
        ...
        <p className="mt-3 text-xs leading-5 text-slate-500">
          이 조회 화면은 개인정보를 저장하지 않으며, 운영 전 검증용 화면입니다.
        </p>
      </form>
      ...
      <article className="rounded-md border border-slate-200 bg-white p-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.08em] text-slate-500">조회 결과</p>
        ...
        <dl className="mt-4 grid gap-3 sm:grid-cols-3">
          <div className="rounded-md bg-slate-50 p-3">
            <dt className="text-xs font-bold uppercase tracking-[0.08em] text-slate-500">결제</dt>
            <dd className="mt-1 text-sm font-black text-slate-950">{result.statusLabel}</dd>
          </div>
          <div className="rounded-md bg-slate-50 p-3">
            <dt className="text-xs font-bold uppercase tracking-[0.08em] text-slate-500">수령/배송</dt>
            <dd className="mt-1 text-sm font-black text-slate-950">{result.fulfillmentLabel}</dd>
          </div>
          <div className="rounded-md bg-slate-50 p-3">
            <dt className="text-xs font-bold uppercase tracking-[0.08em] text-slate-500">갱신</dt>
